            ...
            {[
              {
                ...
                description: 'Designing enterprise-scale travel and AI-driven platforms (Miraee, Aarna, Pranik) used by global travelers and operations teams. Owning end-to-end UX for complex workflows involving bookings, policies, and cost control.',
                tags: ['Enterprise UX', 'AI Workflows', 'SaaS Design', 'Ownership'],
                highlight: true,
              },
              {
                company: 'Virtusa',
                ...
                role: 'UI/UX Designer',
                description: 'Executed design delivery for client product teams. Focused on wireframing, high-fidelity prototyping, and UI theme updates while supporting global design systems.',
                tags: ['Prototyping', 'Theme Systems', 'UX Execution'],
                highlight: false,
              },
              {
                company: 'GlobalLogic',
                ...
                role: 'UI/UX Designer',
                description: 'Focused on foundational UX execution, creating interactive prototypes and component-based UI for complex web and mobile engineering products.',
                tags: ['UX Fundamentals', 'Web & Mobile', 'Component Design'],
                highlight: false,
              },
              {
                company: 'Hita (Parallel)',
                period: 'Self-Initiated',
                role: 'AI Product Builder',
                description: 'Independently conceptualized and built Hita, an AI travel concept. Explored conversational UX and rapid product execution from idea to working prototype.',
                tags: ['Concept-to-Product', 'AI Interaction', 'Rapid Execution'],
                highlight: false,
              },
            ].map((exp, index) => (
              <div
